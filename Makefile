...
pkgdatadir = $(datadir)/unp-examples
pkgincludedir = $(includedir)/unp-examples
pkglibdir = $(libdir)/unp-examples
pkglibexecdir = $(libexecdir)/unp-examples
...
CONFIG_CLEAN_FILES = Make.defines
...
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = unp-examples
PACKAGE_BUGREPORT = john.phillips5@hp.com
PACKAGE_NAME = unp-examples
PACKAGE_STRING = unp-examples 1.0
PACKAGE_TARNAME = unp-examples
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
...
install_sh = ${SHELL} /home/john/code-projects/unp/unp-examples/install-sh
...
Make.defines: $(top_builddir)/config.status $(srcdir)/Make.defines.in
